...
const LandingPage = () => {
  ...
  return (
    <div className="flex flex-col gap-16">
      ...
      <div className="lg:mt-[18rem]" id='about us'>
        ...
        <div className="flex md:ml-12 md:mr-12 ml-4 mr-4">
          <div className="mt-16 flex gap-24">
            <img src='https://tulipmonsellaa.com/wp-content/uploads/elementor/thumbs/5icon-qcyxz2jquavowjs0cnsukawlerupcxb7jn9y0b3sw0.png' className="-mt-4 h-32 w-32 md:block hidden"/>
      ...
      <div id="highlights" className="bg-gray-200 flex md:flex-row flex-col justify-between lg:pl-24 lg:pr-24 pl-8 pr-8">
        <div className="flex flex-col gap-8 lg:m-16 m-4 pt-8 ">
          <div className={`font-serif md:text-2xl text-lg font-bold underline underline-offset-8 decoration-slate-500 text-slate-700 `}>
        ...
        <div className="lg:p-16 flex items-center justify-center">
            <img src="/all-photo.png" className="aspect-video w-[36rem] rounded-xl" />
        </div>
      </div>
      ...
      <div id="location" className="bg-gray-200 flex md:flex-row flex-col justify-between lg:pl-24 lg:pr-24 pl-8 pr-8">
          ...
          <div>
            <ul className="flex flex-col gap-4">
              {locationAdvantages.map((item) => (
                <li className="flex gap-4"> 
                 <span className="text-2xl decoration-slate-500 text-slate-700 "><IoMdCheckmarkCircle /></span>
                 <span className="text-lg">{item}</span>
                </li>
              ))}
            </ul>
        ...
        <div className="lg:p-16 flex items-center justify-center mb-4">
            <img src="/location.jpg" className="aspect-video w-[36rem] rounded-xl" />
        </div>
      </div>

      <div className="w-1/2 md:flex justify-center items-center ml-[22rem] hidden">
        <Form buttonClasses={'w-1/2 ml-44'} />
      </div>
