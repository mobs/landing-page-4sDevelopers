...
const index = () => {
  return (
    <div className="flex flex-col gap-4 md:ml-24 md:mr-24 ml-8 mr-8 mb-8">
      ...
      <span>
        ...
        https://www.4s.propertiesgurugram.com{" "}
      </span>
      ...
      <p>
        ...
        detection. An anonymized string created from your email address (also
      ...
      <p>
        <strong> Suggested text: </strong> If you upload images to the website,
      ...
      <p>
        ...
        cookies. These are for your convenience so that you do not have to fill
      ...
      <p className="font-bold text-2xl">Embedded content from other websites</p>
      <p>
        <strong> Suggested text: </strong> Articles on this site may include
        embedded content (e.g. videos, images, articles, etc.). Embedded content
        from other websites behaves in the exact same way as if the visitor has
      ...
      <p>
        <strong> Suggested text: </strong> If you request a password reset, your
        IP address will be included in the reset email.{" "}
      </p>
      ...
      <p>
        ...
        and its metadata are retained indefinitely. This is so we can recognize
        and approve any follow-up comments automatically instead of holding them
      ...
      <p className="font-bold text-2xl">What rights you have over your data</p>
      <p>
        <strong> Suggested text: </strong> If you have an account on this site,
        or have left comments, you can request to receive an exported file of
      ...
      <p className="font-bold text-2xl">Where your data is sent</p>
      <p>
